            ...
            <div className="container flex items-center justify-center py-4 px-6 mx-auto">
                <form className="w-full max-w-md" onSubmit={handleSubmit}>
                    ...
                    <div className="relative flex items-center mt-8">
                        ...
                        <input type="text" className="block w-full py-3 text-gray-700 bg-white border rounded-md px-11 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" placeholder="Username"  name="name"/>
                    </div>
                    ...
                    <label for="dropzone-file" className="flex items-center px-3 py-3 mx-auto mt-6 text-center bg-white border-2 border-dashed rounded-md cursor-pointer dark:border-gray-600 dark:bg-gray-900">
                        ...
                        <input id="dropzone-file" type="file" className="hidden" name="photoURL"/>
                    </label>
