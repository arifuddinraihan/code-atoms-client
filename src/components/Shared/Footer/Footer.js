        ...
        <div>
            <footer className="bg-white dark:bg-gray-900">
                <div className="container p-6 mx-auto">
                    <div className="lg:flex">
                        ...
                        <div className="mt-6 lg:mt-0 lg:flex-1">
                            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3">
                                ...
                                <div>
                                    <h3 className="text-gray-700 uppercase dark:text-white">Library Used</h3>
                                    <Link className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">Daisy UI</Link>
                                    <Link className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">Meraki UI</Link>
                                </div>

                                <div>
                                    <h3 className="text-gray-700 uppercase dark:text-white">Contact</h3>
                                    <span className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">+880 1621 841412</span>
                                    <span className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">mdarifuddinraihan@email.com</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <p className="text-center text-gray-500 dark:text-gray-400">© Code Atoms 2022 - All rights reserved</p>
                    </div>
                </div>
            </footer>
        </div>
